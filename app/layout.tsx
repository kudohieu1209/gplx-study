...
export const metadata: Metadata = {
  ...
  title: "GPLX - Học 600 câu lý thuyết hạng B",
  description:
    "Học, ôn câu sai và thi thử với đầy đủ 600 câu hỏi sát hạch lái xe hạng B.",
  openGraph: {
    title: "GPLX - Thành thạo 600 câu lý thuyết Hạng B",
    description: "Học theo chương, tra cứu biển báo và thi thử Hạng B.",
    type: "website",
    images: [{ url: "/og-v2.png", width: 1730, height: 909, alt: "GPLX - Thành thạo 600 câu lý thuyết Hạng B" }],
  },
  twitter: {
